...
(define-param eps-under 2.25) ; dielectric constant for space under the waveguide
...
(define-param h-under (* Y 0.5)) ; height of block underneath waveguide
(define-param Y0-under (-(* Y 0.25))) ; center of block underneath waveguide
...
(set! geometry
      (list 
      (make block ; dielectric block _underneath_ the waveguide
        (center 0 Y0-under 0) ; center in lower region of cell
        (size infinity h-under infinity) ; fill lower region of cell
